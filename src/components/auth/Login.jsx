...
//     >
//       <div className="bg-white/10 backdrop-blur-md rounded-xl shadow-lg p-8 w-[500px] border border-white/20 text-white ">

//         <h2 className="text-3xl md:text-[48px] font-medium text-center">Welcome Back</h2>
